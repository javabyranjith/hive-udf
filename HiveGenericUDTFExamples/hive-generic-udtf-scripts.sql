...
ADD JAR /prod/hadoop/user/themescape/ranjith/hiveudf/lib/HiveGenericUDTFExamples-0.1.jar;
ADD FILE /prod/hadoop/user/themescape/ranjith/hiveudf/testdata/genericudtf/hdfs-data.txt;
